...
async function getUsers(request, response, next) {
  try {
    // Dapatkan nomor halaman yang diminta dan ukuran halaman dari query string
    ...
    // Dapatkan daftar pengguna sesuai dengan halaman yang diminta dan ukuran halaman
    const users = await usersService.getUsers(offset, pageSize, sortQuery, searchQuery);
